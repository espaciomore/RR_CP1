...
load_libs("dplyr","plyr","data.table","ggplot2","lattice","cowplot")
```
...
analyticData <- subset(analyticData, steps > 0)
```
...
meanData <- ddply(analyticData, "date", summarise, steps = mean(steps))

hist(meanData$steps, freq= T, ylab= "Days", xlab="Steps", main="", col=rgb(0, 1, 0, 0.25))
```
...
imputedAD <- subset(imputedAD, steps > 0)
```
...
imeanData <- ddply(imputedAD, "date", summarise, steps = mean(steps))

hist(imeanData$steps, freq= T, ylab= "Days", xlab="Steps", main="", col=rgb(0, 1, 0, 0.25))
hist(meanData$steps, freq= T, ylab= "Days", xlab="Steps", main="", add=T, col=rgb(0, 1, 0, 0.25))
```
